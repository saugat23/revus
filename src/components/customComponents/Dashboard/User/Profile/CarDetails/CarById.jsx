              ...
              <div className="py-8">
                <Tabs defaultValue="description" className="w-full">
                  <TabsList>
                    <TabsTrigger
                      value="description"
                      className="font-semibold !data-[state=active]:bg-transparent !data-[state=active]:text-primary !data-[state=active]:border-b-2 border-b-secondary"
                    >
                      Vehicle Description
                    </TabsTrigger>
                    ...
                    <TabsTrigger value="review" className="font-semibold">
                      Reviews
                    </TabsTrigger>
                  </TabsList>
                  <TabsContent
